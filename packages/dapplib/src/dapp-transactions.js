		...
		return fcl.transaction`
				...
				transaction() {
				  ...
				  prepare(signer: AuthAccount) {
				    ...
				    if signer.borrow<&RegistrySampleContract.Tenant{RegistrySampleContract.ITenantPublic}>(from: RegistrySampleContract.TenantStoragePath) == nil {
				      ...
				      // 
				      signer.link<&RegistrySampleContract.Tenant{RegistrySampleContract.ITenantPublic}>(RegistrySampleContract.TenantPublicPath, target: RegistrySampleContract.TenantStoragePath)
				    }
				  }
